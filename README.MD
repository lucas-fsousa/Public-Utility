...
```bash
EXAMPLE
PM> Install-Package LucasFsousa.PublicUtility -Version 1.0.3

.NET CLI> dotnet add package LucasFsousa.PublicUtility --version 1.0.3

Package Reference> <PackageReference Include="LucasFsousa.PublicUtility" Version="1.0.3" />
